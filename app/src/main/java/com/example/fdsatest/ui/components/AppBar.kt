...
import com.example.fdsatest.ui.theme.SurfaceColorLight
...
fun AppBar(
    ...
    val colors = TopAppBarDefaults.topAppBarColors(
        ...
        titleContentColor = SurfaceColorLight,
        actionIconContentColor = SurfaceColorLight,
        navigationIconContentColor = SurfaceColorLight
    )
